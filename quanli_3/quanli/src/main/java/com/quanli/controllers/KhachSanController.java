...
public class KhachSanController {
    ...
    public String showdetailKS(@PathVariable(name="id")int id,@RequestParam(name="name", required = false,defaultValue = "")String name,Model model)
    {
        ...
        model.addAttribute("khachsan1", this.khachSanService.getKhachSanByTP(name));
        return "detailKS";
    }
    ...
    {
       this.khachSanService.update(khachsan);
       return "redirect:/admin/khachsan";
    }
}
