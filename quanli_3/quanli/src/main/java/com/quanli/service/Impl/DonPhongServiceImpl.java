...
public class DonPhongServiceImpl implements DonPhongService{
    ...
    @Override
    public DonPhong getDPById(int id) {
        return this.donPhongRepository.getDPById(id);
    }
    ...
    @Override
    public List<DonPhong> getDonPhongByDate(String string) {
     return this.donPhongRepository.getDonPhongByDate(string);
    }
