                 ...
                 <td>${t.id}</td>
                  ...
                  <td>
                    <a class="btn btn-info"href="<c:url value="/admin/hoadon/detail/${t.id}"/>">Thông tin</a>
                     ...
                     <a class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa? ')" href="<c:url value="/admin/hoadon/xoa/${t.id}"/>">Xóa</a>
                  </td>
            </tr>
        </c:forEach>
     </tbody>
                 ...
                 <td>${t.id}</td>
                  ...
                  <td>
                    <a class="btn btn-info"href="<c:url value="/admin/hoadon/tour/detail/${t.id}"/>">Thông tin</a>
                     ...
                     <a class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa? ')" href="<c:url value="/admin/hoadon/tour/xoa/${t.id}"/>">Xóa</a>
                  </td>
            </tr>
        </c:forEach>
     </tbody>
